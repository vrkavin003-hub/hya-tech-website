...
export default function ProjectHero() {
  ...
  return (
    <section className="about-hero project-hero">
      <video
      ...
      <div className="about-content">
        ...
        <p className="about-small">OUR PORTFOLIO</p>

        <h1 className="about-title">
          Projects And <span>Gallery</span>
        </h1>

        <p className="about-desc">
          Showcasing our precision manufacturing excellence across industries
        </p>
