...
const data = [
  ...
  { title: "Bending", desc: "Precision bending with angle and radius control", icon: "📐" },
  { title: "Laser Cutting", desc: "Precision laser cutting with adjustable power and speed control", icon: "✂️" },
  { title: "Laser Welding", desc: "High-precision laser welding for various materials", icon: "⚡" },
  {title:"Mid Welding", desc: "Mid-range welding solutions for efficient production", icon: "🔥"},
  {title:"TBU", desc: "Thermal Bonding Unit", icon: "♨️"}
];
